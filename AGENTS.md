# papiflyfx-docking-platform Agent Guidance
...
- `@spec-steward` - Owns cross-cutting specs, roadmap, progress tracking, acceptance criteria, and delivery coordination.
